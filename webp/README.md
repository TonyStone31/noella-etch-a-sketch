...
| `LICENSE-Xelitan.txt` | his license, kept with his code |
...
frame of flat color and one-pixel lines, encoded and decoded again, came back
...
A real match finder, a color cache and cross-color would go further still;
